...
const equipment: EquipmentItem[] = [
  ...
  { qty: 1, description: 'VT GUARUJÁ', total: 1000 },
...
const timeline: TimelineItem[] = [
  {
    date: '11/03/2026',
    title: 'Carga de equipamentos',
    description: 'Separação, conferência e carregamento dos equipamentos para deslocamento ao Guarujá.',
  },
  {
    date: '12/03/2026',
    title: 'Deslocamento da equipe / Pré-light',
    description: 'Viagem da equipe e preparação técnica no local para a captação do dia seguinte.',
  },
  {
    date: '13/03/2026',
    title: 'Filmagem',
    description: 'Captação das entrevistas de Galvão Bueno no Guarujá.',
  },
];
...
const GuarujaQuote: React.FC = () => {
  ...
  const getNextInvoiceNumber = () => {
    const lastNumber = localStorage.getItem('lastInvoiceNumberGuaruja');
    if (!lastNumber) return '000119';
        ...
        <header className="px-12 md:px-16 py-10 border-b-2 border-slate-100 bg-white">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            ...
            <div className="text-right">
              ...
              <p className="text-slate-500 font-mono text-xs mt-1">REF: #2026-GB-GUARUJA</p>
              <p className="text-slate-500 font-mono text-xs">DATA: 19/03/2026</p>
            </div>
          </div>
        </header>
          ...
          <section className="relative px-12 md:px-16 py-20 bg-slate-900 overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <h1 className="text-5xl md:text-6xl font-display font-bold text-white mb-6 leading-tight">
                Galvão Bueno <br />
                <span className="text-slate-300">Entrevistas (Guarujá)</span>
              </h1>
              <p className="text-xl text-slate-300 font-light leading-relaxed mb-10 max-w-2xl">
                Relatório técnico e financeiro referente à locação de equipamento de projeção e suporte técnico executados para gravação de entrevistas no Guarujá.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 border-t border-slate-700 pt-8">
                ...
                <div>
                  ...
                  <p className="font-medium text-white text-sm">Guarujá, SP</p>
                ...
                <div>
                  ...
                  <p className="font-medium text-white">11 a 13 Mar</p>
            ...
            <section>
              ...
              <div className="mb-8 bg-slate-50 border border-slate-200 rounded-sm overflow-hidden break-inside-avoid">
                <div className="bg-slate-100 px-4 py-2 border-b border-slate-200 flex justify-between items-center">
                  <h3 className="font-bold text-slate-700 uppercase text-xs tracking-wider">Entrevistas (Guarujá)</h3>
