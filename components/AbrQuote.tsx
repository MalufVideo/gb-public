...
const AbrQuote: React.FC = () => {
  ...
  const getNextInvoiceNumber = () => {
    const lastNumber = localStorage.getItem('lastInvoiceNumberAbr');
    if (!lastNumber) return '000121';
        ...
        <header className="px-12 md:px-16 py-10 border-b-2 border-slate-100 bg-white">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            ...
            <div className="text-right">
              ...
              <p className="text-slate-500 font-mono text-xs mt-1">REF: #2026-GB-ABR</p>
          ...
          <section className="relative px-12 md:px-16 py-20 bg-slate-900 overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <h1 className="text-5xl md:text-6xl font-display font-bold text-white mb-6 leading-tight">
                Galvão Bueno <br />
                <span className="text-slate-300">Entrevistas (Abril)</span>
              </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 border-t border-slate-700 pt-8">
                ...
                <div>
                  ...
                  <p className="font-medium text-white">14 Abr 2026</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <section>
              ...
              <div className="mb-8 bg-slate-50 border border-slate-200 rounded-sm overflow-hidden break-inside-avoid">
                <div className="bg-slate-100 px-4 py-2 border-b border-slate-200 flex justify-between items-center">
                  <h3 className="font-bold text-slate-700 uppercase text-xs tracking-wider">Entrevistas (Abril)</h3>
                  ...
                  <tbody className="divide-y divide-slate-200 bg-white">
                    {timeline.map((item, index) => (
                      <tr key={item.date} className={index % 2 === 1 ? 'bg-slate-50' : ''}>
                        ...
                        <td className="px-6 py-4 text-right"><span className="inline-block px-2 py-1 bg-emerald-100 text-emerald-700 rounded text-xs font-bold">PREVISTO</span></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
